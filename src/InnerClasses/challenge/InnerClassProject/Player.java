...
public class Player {
    ...
    public static void main(String[] args) {
        ...
        Album album = new Album("Storm bringer", "Deep Purple"); // outer class
...
//        albums.get(2).addToPLayList("String", playList);
...
//        play(playList);
    ...
    // Modify the playlist challengePreparation so that the Album class uses an inner class.
