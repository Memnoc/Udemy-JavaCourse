...
//        Sayian Goku = new Sayian("Goku", "base form");
//        What changes is the access to the inner class = OuterClass.InnerClass name = outerClassObjectName.new
//        Sayian.Transformation superSayan = Goku.new Transformation("Super Sayian",1);
//
//        System.out.println(Goku.getName() + " is transforming into " + superSayan.getTransformationName() + " " + superSayan.getTransformationPowerLevel());
        ...
        Sayian goku = new Sayian("Goku", "Base form", 100);
